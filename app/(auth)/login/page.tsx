...
export default function login() {
    ...
    <div className="Customer_big_container bg-slate-200 flex items-center justify-center p-10 max-sm:p-0">
        <div className="Customer_container bg-white w-1/2 rounded-xl shadow-lg p-4 border-indigo-500 max-w-lg max-md:h-5/6  max-sm:w-full max-sm:m-5  ...">
            ...
            <form className="Customer_form max-md:w-full max-md:m-0  max-lg:w-full h-64">
                ...
                <div className="flex justify-center">
                    <input className="pl-2 max-lg:w-full max-md:w-full max-md:m-0    text-white pointer-events-auto rounded-xl h-14 w-3/4 bg-gradient-to-r from-purple-700 to-pink-700" type="email" id="Email" /> 
                </div> 
                <br />
                ...
                <label  className="Customer_label max-lg:left-2 max-md:left-2  max-md:text-sm   font-black cursor-text relative bottom-1 left-20  text-purple-800 text-base" htmlFor="Password">Password :</label>
                    <div className="flex justify-center">
                    <input  className="pl-2 max-lg:w-full max-md:w-full max-md:m-0   text-white pointer-events-auto rounded-xl h-14 w-3/4 bg-gradient-to-r from-purple-700 to-pink-700"  type="password" id="Password" /> 
                </div>
